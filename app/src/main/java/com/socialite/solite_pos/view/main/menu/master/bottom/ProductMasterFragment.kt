...
class ProductMasterFragment(private val product: ProductWithCategory?) :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            red =
                ResourcesCompat.getColor(activity!!.resources, android.R.color.holo_red_light, null)
    ...
    private fun setData() {
        if (product != null) {
            ...
            lifecycleScope.launch {
                viewModel.getProductVariantOptions(product.product.id)
                    .collect {
                        if (it != null) {
                            var count = 0
                            for (item in it) {
                            ...
                            _binding.btnPmVariant.text = "Terdapat $count Varian"
                        }
                    }
            }
