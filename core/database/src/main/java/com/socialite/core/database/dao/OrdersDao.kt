...
import com.socialite.schema.database.bridge.OrderPromo
...
interface OrdersDao {
    ...
    @Query("SELECT * FROM '${NewOrder.DB_NAME}' WHERE ${NewOrder.UPLOAD} = 0")
    ...
    @Query("DELETE FROM '${com.socialite.schema.database.new_bridge.OrderDetail.DB_NAME}'")
    suspend fun deleteAllNewOrderDetails()

    @Query("DELETE FROM '${com.socialite.schema.database.new_bridge.OrderPayment.DB_NAME}'")
    suspend fun deleteAllNewOrderPayments()

    @Query("DELETE FROM '${com.socialite.schema.database.new_bridge.OrderPromo.DB_NAME}'")
    suspend fun deleteAllNewOrderPromos()

    @Query("DELETE FROM '${com.socialite.schema.database.new_bridge.OrderProductVariant.DB_NAME}'")
